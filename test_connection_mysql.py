...
with mysql.connector.connect(
    ...
    insert_promotion('BAC 1 Génie Logiciel', connection)
    insert_promotion('BAC 1 Systèmes Informatiques', connection)
    insert_promotion('BAC 2 Génie Logiciel', connection)
    insert_promotion('BAC 1 Systèmes Informatiques', connection)
